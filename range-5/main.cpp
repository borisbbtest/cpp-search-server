...
vector<Document> FindAllDocuments( const map<string, set<int>>& word_to_documents,  const set<string>& stop_words,  const string& query)
...
vector<Document> FindTopDocuments( const map<string, set<int>>& word_to_documents, const set<string>& stop_words,  const string& query)
...
Терминал
Задача прошла 8/10 проверок

Возможные проблемы:
- Вы не верно реализовали функцию FindAllDocuments.
- Вы не верно реализовали функцию FindTopDocuments

Урок 4 Сортировка вектора структуры. 